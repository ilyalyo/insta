...
class DefaultController extends Controller
{
    ...
    const REDIRECT_URL='http://test.instastellar.su/app_dev.php/get_token';
    ...
    {
        return $this->redirect('https://instagram.com/oauth/authorize/?client_id=6e336200a7f446a78b125602b90989cc&response_type=code&redirect_uri=http://test.instastellar.su/app_dev.php/get_token&scope=likes+comments+relationships');
    }
